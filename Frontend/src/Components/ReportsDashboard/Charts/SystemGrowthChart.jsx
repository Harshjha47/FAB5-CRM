          ...
          <div className="flex items-center bg-slate-100 p-1 rounded-lg border border-slate-200">
            <button
              ...
              className={`px-3 py-1.5 text-sm font-medium rounded-md transition-colors flex items-center gap-2 ${
                viewMode === 'global' ? 'bg-white text-indigo-700 shadow-sm' : 'text-slate-500 hover:text-slate-700'
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-1.5 text-sm font-medium rounded-md transition-colors flex items-center gap-2 ${
                viewMode === 'breakout' ? 'bg-white text-indigo-700 shadow-sm' : 'text-slate-500 hover:text-slate-700'
              }`}
            >
            ...
            {['day', 'month', 'year'].map((range) => (
              <button
                ...
                className={`px-4 py-1.5 text-sm font-medium rounded-md capitalize transition-colors ${
                  timeRange === range ? 'bg-white text-indigo-700 shadow-sm' : 'text-slate-500 hover:text-slate-700'
                }`}
              >
                {range}
              </button>
